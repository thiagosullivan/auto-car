    ...
    <div>
      <Dialog>
        <DialogTrigger asChild>
          <p className="text-red-one font-semibold cursor-pointer">
          ...
          <DialogHeader>
            ...
            <DialogDescription className="text-justify">
              <p>
                ...
                <a href="https://www.autocar.com.br">Auto Car</a>, e outros
              ...
              <p>
                ...
                informação que o Auto Car oferece no site e com caráter
              ...
              <ul className="list-disc pl-8 py-4">
                ...
                <li>
                  ...
                  (softwares) do Auto Car, de seus fornecedores ou terceiros,
