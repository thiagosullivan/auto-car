...
const PoliticsPage = () => {
  return (
    <div className="w-full max-w-7xl mx-auto px-4 my-10 text-justify ">
      <div className="bg-white p-10 rounded-2xl shadow-lg">
        <h1 className="text-2xl font-bold mb-4">Políticas de Privacidade</h1>
        <p>
          A sua privacidade é importante para nós. É política do Auto Car
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site{" "}
          <a href="https://www.autocar.com.br">Auto Car</a>, e outros sites que
        ...
        <a
          ...
          target="_blank"
          style={{
            backgroundColor: "transparent; color: rgb(68, 68, 68)",
          }}
        >
        ...
        <h3 className="font-bold text-base">Compromisso do Usuário</h3>
        <p>
          O usuário se compromete a fazer uso adequado dos conteúdos e da
          informação que o Auto Car oferece no site e com caráter enunciativo,
          mas não limitativo:
        </p>
        <ul className="list-disc pl-8 py-4">
          ...
          <li>
            ...
            (softwares) do Auto Car, de seus fornecedores ou terceiros, para
        ...
        <h3 className="font-bold text-base">Mais informações</h3>
        <p>
        ...
        <p>Esta política é efetiva a partir de&nbsp;1 September 2025 14:53</p>
      </div>
    </div>
  );
};
